  ...
  const handleChange = (e) => {
    ...
    if (name.split("--")[0] != "support")
      data["coeff"] = data["coeff"]
        ? data["coeff"] + quoeff[name.split("--")[0]][e.target.value]
        : quoeff[name.split("--")[0]][e.target.value];
    else {
  ...
  return (
    <>
      ...
      <main className={`w-100 container-fluid pb-5 ${styles.main}`}>
        ...
        {!loading && (
          <div
            className={`d-flex flex-column w-75 mx-auto justify-content-center align-items-center py-2 ${styles.formsContainer}`}
          >
            {imagesObjects.map((e) => {
              return (
                <div
                  key={e._id}
                  className={`${styles.form} d-flex flex-column align-items-center`}
                >
                  <div
                    style={{
                      width: 100,
                    ...
                    <div className="form-group mr-3 col-6">
                      ...
                      >
                        ...
                        <option value="couverture">
                          2ème, 3ème our 4ème de couverture
                        </option>
                  ...
                  <div className="text-white">
                    Prix de base:{" "}
                    {formData[e._id] && formData[e._id]["base"] ? (
                      formData[e._id]["base"]
                    ) : (
                      <small>Veuillez choisir le support..</small>
                    )}
                  </div>
                  <div className="text-white">
                    Prix :{" "}
